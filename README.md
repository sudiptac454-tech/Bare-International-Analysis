**Style Advisor Performance Analysis**

Driving Retail Performance Insights Using Data

Author: Sudipta Chakraborty

**Project Summary**

Analyzed Style Advisor performance across 4 retail zones using mystery shopping audit data to uncover performance gaps, improve customer experience, and enable data-driven decision-making.

This project transforms raw audit observations into actionable business insights, identifying underperforming regions and opportunities to improve sales and service quality.

**Business Problem**

**Retail teams lacked visibility into:**

Inconsistent customer experience across locations
Advisor performance gaps by region
Missed upselling and engagement opportunities
...
Zone-wise Aggregation (Pivot Analysis)
Distribution Analysis (High vs Low Performers)
...
Data Interpretation: Converting data into actionable insights
Visualization: Trend and distribution analysis
Project Deliverable
...
Identify performance gaps with measurable impact
Recommend data-backed strategic actions

**About Me**

I’m a data-driven problem solver focused on turning business challenges into actionable insights. This project reflects my ability to combine analytics, business understanding, and storytelling.
